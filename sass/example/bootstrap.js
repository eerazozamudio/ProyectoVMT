...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.cmd": "../../../../../Users/eeraz/bin/Sencha/Cmd/6.5.0.180/plugins/src",
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "ExtMVC.Application": [],
  "ExtMVC.controller.AsentamientoHumano": [],
  "ExtMVC.controller.Asociacion": [],
  "ExtMVC.controller.Barrio": [],
  "ExtMVC.controller.Beneficiario": [],
  "ExtMVC.controller.Cargo": [],
  "ExtMVC.controller.Central": [],
  "ExtMVC.controller.Comite": [],
  "ExtMVC.controller.Condicionbeneficiario": [],
  "ExtMVC.controller.Cooperativa": [],
  "ExtMVC.controller.Coordinador": [],
  "ExtMVC.controller.Etapa": [],
  "ExtMVC.controller.Grupo": [],
  "ExtMVC.controller.Lote": [],
  "ExtMVC.controller.Main": [],
  "ExtMVC.controller.Manzana": [],
  "ExtMVC.controller.Menu": [],
  "ExtMVC.controller.Opcion": [],
  "ExtMVC.controller.Parcela": [],
  "ExtMVC.controller.Referencia": [],
  "ExtMVC.controller.Reporte": [],
  "ExtMVC.controller.ReporteGenerarRequerimiento": [],
  "ExtMVC.controller.ReporteGenerarRequerimientoHistorico": [],
  "ExtMVC.controller.ReporteRequerimientoInei": [],
  "ExtMVC.controller.Sector": [],
  "ExtMVC.controller.SectorGrupoMzLt": [],
  "ExtMVC.controller.Sexo": [],
  "ExtMVC.controller.Socio": [],
  "ExtMVC.controller.Supervisor": [],
  "ExtMVC.model.Centro": [],
  ...
  "ExtMVC.view.comite.ComiteComentario": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "ExtMVC.view.Viewport": [],
  "ExtMVC.view.asentamientohumano.AsentamientoHumanoGrid": [
    "widget.asentamientohumanogrid"
  ],
  "ExtMVC.view.asociacion.AsociacionGrid": [
    "widget.asociaciongrid"
  ],
  "ExtMVC.view.barrio.BarrioGrid": [
    "widget.barriogrid"
  ],
  "ExtMVC.view.beneficiario.BeneficiarioForm": [
    "widget.beneficiarioform"
  ],
  "ExtMVC.view.beneficiario.BeneficiarioGrid": [
    "widget.beneficiariogrid"
  ],
  "ExtMVC.view.beneficiario.BeneficiarioTodosGrid": [
    "widget.beneficiariotodosgrid"
  ],
  "ExtMVC.view.beneficiario.BeneficiarioWindow": [
    "widget.beneficiariowindow"
  ],
  "ExtMVC.view.beneficiario.SocioModificar": [
    "widget.sociomodificar"
  ],
  "ExtMVC.view.beneficiario.SocioModificarForm": [
    "widget.frmsociomodificar"
  ],
  "ExtMVC.view.central.CentralBuscarGrid": [
    "widget.centralbuscargrid"
  ],
  "ExtMVC.view.central.CentralGrid": [
    "widget.centralgrid"
  ],
  "ExtMVC.view.comite.BuscarCentralComiteWindow": [
    "widget.buscarcentralcomitewindow"
  ],
  "ExtMVC.view.comite.ComiteBuscarGrid": [
    "widget.comitebuscargrid"
  ],
  "ExtMVC.view.comite.ComiteComentario": [
    "widget.comitecomentarioform"
  ],
  "ExtMVC.view.comite.ComiteForm": [
    "widget.comiteform"
  ],
  ...
  "ExtMVC.view.comite.ComiteTodosGrid": [
    "widget.comitetodosgrid"
  ],
  "ExtMVC.view.cooperativa.CooperativaGrid": [
    "widget.cooperativagrid"
  ],
  "ExtMVC.view.coordinador.CoordinadorForm": [
    "widget.coordinadorform"
  ],
  "ExtMVC.view.coordinador.CoordinadorGrid": [
    "widget.coordinadorgrid"
  ],
  "ExtMVC.view.etapa.EtapaGrid": [
    "widget.etapagrid"
  ],
  ...
  "ExtMVC.view.mantenimiento.CentralComitePanel": [
    "widget.centralcomitepanel"
  ],
  "ExtMVC.view.mantenimiento.CentralComiteSocioPanel": [
    "widget.centralcomitesociopanel"
  ],
  "ExtMVC.view.manzana.ManzanaGrid": [
    "widget.manzanagrid"
  ],
  ...
  "ExtMVC.view.referencia.ReferenciaGrid": [
    "widget.referenciagrid"
  ],
  "ExtMVC.view.reporte.ReporteGenerarRequerimientoHistoricoPanel": [
    "widget.reportegenerarrequerimientohistoricopanel"
  ],
  "ExtMVC.view.reporte.ReporteGenerarRequerimientoPanel": [
    "widget.reportegenerarrequerimientopanel"
  ],
  "ExtMVC.view.reporte.ReporteRequerimientoIneiPanel": [
    "widget.reporterequerimientoineipanel"
  ],
  "ExtMVC.view.reporte.beneficiario.ReporteBeneficiarioPanel": [
    "widget.reportebeneficiariopanel"
  ],
  "ExtMVC.view.reporte.socio.ReporteSocioPanel": [
    "widget.reportesociopanel"
  ],
  "ExtMVC.view.sector.SectorGrid": [
    "widget.sectorgrid"
  ],
  ...
  "ExtMVC.view.socio.SocioTodosGrid": [
    "widget.sociotodosgrid"
  ],
  "ExtMVC.view.socio.SocioTrasladarForm": [
    "widget.sociotrasladarform"
  ],
  "ExtMVC.view.supervisor.SupervisorForm": [
    "widget.supervisorform"
  ],
  "ExtMVC.view.supervisor.SupervisorGrid": [
    "widget.supervisorgrid"
  ],
  "ExtThemeNeptune.Component": [],
  "ExtThemeNeptune.container.ButtonGroup": [],
  "ExtThemeNeptune.form.field.HtmlEditor": [],
...
Ext.setVersion("empadronacion", "1.0.0");
...
Ext.Loader.loadScriptFile('../../packages/empadronacion/overrides/init.js', Ext.emptyFn);
